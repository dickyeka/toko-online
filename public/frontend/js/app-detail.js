  ...
  (function($) {
    ...
    $.countdown.defaultOptions = {
      ...
      render: function(date) {
        return $(this.el).html(date.days + " Hari : " + (this.leadingZeros(date.hours)) + " : "+ (this.leadingZeros(date.min)) + " : " +(this.leadingZeros(date.sec)));
      }
    };
...
$(function(){
	...
	$('#tab-info>li>a').click(function (e) {
	  e.preventDefault();
	  $(this).tab('show');
	});
});
